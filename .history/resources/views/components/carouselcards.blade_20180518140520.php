    ...
    <div class="container p-t-0 m-t-2 carousel-inner">
        <div class="row row-equal carousel-item active m-t-0">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-block p-t-2">
                        ...
                        <h6 class="small text-wide p-b-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus quasi molestiae sint animi totam laborum aut, voluptas dolor placeat! Enim, nisi cum fuga asperiores harum nulla in! Praesentium, nulla numquam!</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-img-top card-img-top-250">
                        <img class="img-fluid" src="https://i.imgur.com/g27lAMl.png" alt="Carousel 3">
                    </div>
                    <div class="card-block p-t-2">
